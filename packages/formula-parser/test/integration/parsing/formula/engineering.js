...
describe(".parse() engineering formulas", () => {
  ...
  it("BESSELI", () => {
    expect(parser.parse("BESSELI()")).toMatchObject({ error: null, result: 1 });
  ...
  it("BITAND", () => {
    expect(parser.parse("BITAND()")).toMatchObject({ error: null, result: 0 });
    expect(parser.parse("BITAND(2)")).toMatchObject({ error: null, result: 0 });
  ...
  it("BITOR", () => {
    expect(parser.parse("BITOR()")).toMatchObject({ error: null, result: 0 });
    expect(parser.parse("BITOR(2)")).toMatchObject({ error: null, result: 2 });
  ...
  it("BITXOR", () => {
    expect(parser.parse("BITXOR()")).toMatchObject({ error: null, result: 0 });
    expect(parser.parse("BITXOR(2)")).toMatchObject({ error: null, result: 2 });
  ...
  it("COMPLEX", () => {
    expect(parser.parse("COMPLEX()")).toMatchObject({ error: null, result: 0 });
  ...
  it("CONVERT", () => {
    ...
    expect(parser.parse('CONVERT(100, "km", "mi")')).toBeMatchCloseTo({
      error: null,
  ...
  it("DELTA", () => {
    expect(parser.parse("DELTA()")).toMatchObject({ error: null, result: 1 });
  ...
  it("GESTEP", () => {
    expect(parser.parse("GESTEP()")).toMatchObject({ error: null, result: 1 });
