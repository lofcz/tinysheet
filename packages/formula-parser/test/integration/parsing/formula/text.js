...
describe(".parse() text formulas", () => {
  ...
  it("LEFT", () => {
    expect(parser.parse("LEFT()")).toMatchObject({ error: null, result: "" });
  ...
  it("REPT", () => {
    expect(parser.parse("REPT()")).toMatchObject({ error: null, result: "" });
  ...
  it("RIGHT", () => {
    expect(parser.parse("RIGHT()")).toMatchObject({ error: null, result: "" });
  ...
  it("UPPER", () => {
    expect(parser.parse("UPPER()")).toMatchObject({ error: null, result: "" });
  ...
  xit("VALUE", () => {
    expect(parser.parse("VALUE()")).toMatchObject({ error: null, result: 0 });
