...
describe(".parse() math-trig formulas", () => {
  ...
  it("ABS", () => {
    expect(parser.parse("ABS()")).toMatchObject({ error: null, result: 0 });
  ...
  it("ASIN", () => {
    expect(parser.parse("ASIN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("ASINH", () => {
    expect(parser.parse("ASINH()")).toMatchObject({ error: null, result: 0 });
  ...
  it("ATAN", () => {
    expect(parser.parse("ATAN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("ATAN2", () => {
    expect(parser.parse("ATAN2()")).toMatchObject({ error: null, result: 0 });
  ...
  it("ATANH", () => {
    expect(parser.parse("ATANH()")).toMatchObject({ error: null, result: 0 });
  ...
  it("CEILING", () => {
    ...
    expect(parser.parse("CEILING(-1.234, 0.1)")).toBeMatchCloseTo({
      error: null,
      result: -1.2,
    });
    expect(parser.parse('CEILING(-1.234, 0.1, "value")')).toBeMatchCloseTo({
      error: null,
      result: -1.2,
    });
  });
  ...
  it("COMBIN", () => {
    expect(parser.parse("COMBIN()")).toMatchObject({ error: null, result: 1 });
    expect(parser.parse('COMBIN("value")')).toMatchObject({
      error: "#VALUE!",
      result: null,
    });
    expect(parser.parse("COMBIN(1)")).toMatchObject({ error: null, result: 1 });
  ...
  it("COMBINA", () => {
    expect(parser.parse("COMBINA()")).toMatchObject({ error: null, result: 1 });
  ...
  it("COS", () => {
    expect(parser.parse("COS()")).toMatchObject({ error: null, result: 1 });
  ...
  it("COSH", () => {
    expect(parser.parse("COSH()")).toMatchObject({ error: null, result: 1 });
  ...
  it("DEGREES", () => {
    expect(parser.parse("DEGREES()")).toMatchObject({ error: null, result: 0 });
  ...
  it("EVEN", () => {
    expect(parser.parse("EVEN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("EQ", () => {
    // Equal
    expect(parser.parse("EQ()")).toMatchObject({
      error: "#NAME?",
      result: null,
    });
  ...
  it("FLOOR", () => {
    ...
    expect(parser.parse("FLOOR(1)")).toMatchObject({
      error: "#VALUE!",
      result: null,
    });
  ...
  it("LT", () => {
    // Less than
    expect(parser.parse("LT()")).toMatchObject({
      error: "#NAME?",
      result: null,
    });
  ...
  it("NE", () => {
    // Not Equal
    expect(parser.parse("NE()")).toMatchObject({
      error: "#NAME?",
      result: null,
    });
  ...
  it("ODD", () => {
    expect(parser.parse("ODD()")).toMatchObject({ error: null, result: 1 });
  ...
  it("POWER", () => {
    ...
    expect(parser.parse("POWER(2)")).toMatchObject({ error: null, result: 1 });
  ...
  it("PRODUCT", () => {
    expect(parser.parse("PRODUCT()")).toMatchObject({ error: null, result: 0 });
    expect(
  ...
  it("RADIANS", () => {
    expect(parser.parse("RADIANS()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SEC", () => {
    expect(parser.parse("SEC()")).toMatchObject({ error: null, result: 1 });
  ...
  it("SECH", () => {
    expect(parser.parse("SECH()")).toMatchObject({ error: null, result: 1 });
  ...
  it("SIGN", () => {
    expect(parser.parse("SIGN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SIN", () => {
    expect(parser.parse("SIN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SINH", () => {
    expect(parser.parse("SINH()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SQRT", () => {
    expect(parser.parse("SQRT()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SQRTPI", () => {
    expect(parser.parse("SQRTPI()")).toMatchObject({ error: null, result: 0 });
  ...
  it("SUMSQ", () => {
    expect(parser.parse("SUMSQ()")).toMatchObject({ error: null, result: 0 });
    expect(
      // Typed text that is not a number is #VALUE! (text in referenced
      // cells is skipped).
  ...
  it("TAN", () => {
    expect(parser.parse("TAN()")).toMatchObject({ error: null, result: 0 });
  ...
  it("TANH", () => {
    expect(parser.parse("TANH()")).toMatchObject({ error: null, result: 0 });
  ...
  it("TRUNC", () => {
    expect(parser.parse("TRUNC()")).toMatchObject({ error: null, result: 0 });
