export default {
  ...
  definedNames: {
    ...
    filterAll: "所有名称",
    filterWorkbook: "工作簿范围的名称",
    filterSheet: "工作表范围的名称",
    filterErrors: "有错误的名称",
    createFromSelection: "根据所选内容创建…",
    createFromSelectionTitle: "根据下列内容中的值创建名称：",
    topRow: "首行",
    leftColumn: "最左列",
    bottomRow: "末行",
    rightColumn: "最右列",
    ...
    refersTo: "引用位置：",
    empty: "尚未定义名称。",
    noMatch: "没有与筛选条件匹配的名称。",
    deleteConfirm: "删除所选名称？",
    namesCreated: "已创建名称：",
    invalidReference: "引用或名称无效。",
    errorEmpty: "请输入名称。",
    errorTooLong: "名称最多可包含 255 个字符。",
    errorInvalidChars:
      "名称必须以字母、下划线或反斜杠开头，且只能包含字母、数字、句点和下划线。",
    errorCellReference: "名称不能与单元格引用相同，例如 A1 或 R1C1。",
    errorReserved: "TRUE 和 FALSE 不能用作名称。",
    errorDuplicate: "此名称已存在。",
    errorEmptyDefinition: "请输入名称的引用位置。",
  },
  tables: {
    ...
    lastColumn: "最后一列",
    totals: "汇总行函数",
    convertToRange: "转换为区域",
    convertConfirm: "是否将表转换为普通区域？",
    resize: "调整表格大小",
    fnNone: "无",
    fnSum: "求和",
    fnAverage: "平均值",
    ...
    fnStdDev: "标准偏差",
    fnVar: "方差",
    errorOverlap: "表不能与其他表重叠。",
    errorMerged: "表不能包含合并单元格。",
    errorInvalidRange: "引用无效。",
    errorNoRoom: "表下方的行必须为空。",
    errorInvalidName: "表名称无效。",
    errorDuplicateName: "已存在同名的表或名称。",
    errorNotFound: "该表已不存在。",
    styleBlue: "蓝色",
    styleOrange: "橙色",
    styleGray: "灰色",
    styleGold: "金色",
  ...
  spill: {
    notBlank: "溢出区域不为空",
    notBlankDetail: "公式结果无法溢出，因为溢出区域中的单元格不为空。",
    selectObstructing: "选择阻碍单元格",
  },
  pasteSpecial: {
    title: "选择性粘贴",
    paste: "粘贴",
    operation: "运算",
    all: "全部",
    allUsingSourceColumnWidths: "全部（使用源列宽）",
    formulas: "公式",
    values: "数值",
    formats: "格式",
    comments: "批注",
    validation: "验证",
    allExceptBorders: "边框除外",
    columnWidths: "列宽",
    formulasAndNumberFormats: "公式和数字格式",
    valuesAndNumberFormats: "值和数字格式",
    none: "无",
    add: "加",
    subtract: "减",
    multiply: "乘",
  ...
  shape: {
    ...
    ungroup: "取消组合",
    alignObjects: "对齐",
    alignObjectsLeft: "左对齐",
    alignObjectsCenter: "水平居中",
    alignObjectsRight: "右对齐",
    alignObjectsTop: "顶端对齐",
    alignObjectsMiddle: "垂直居中",
    alignObjectsBottom: "底端对齐",
    distributeHorizontally: "横向分布",
    distributeVertically: "纵向分布",
    size: "大小",
    width: "宽度",
    height: "高度",
    rotation: "旋转",
  ...
  cellImage: {
    pictureInCell: "单元格中的图片",
    insertTitle: "在单元格中插入图片",
    placeInCell: "放置在单元格中",
    placeOverCells: "放置在单元格上",
    insertPicture: "在单元格中放置图片…",
    altText: "替换文字…",
    altTextTitle: "替换文字",
    altTextLabel: "为看不到此图片的用户描述图片",
    fromFile: "此设备…",
    fromUrl: "来自网址",
    urlLabel: "图片地址（https:// 或 data:image）",
    invalidUrl: "请输入图片的 https:// 地址。",
    readFailed: "无法读取图片。",
    picture: "图片",
    deletePicture: "删除图片",
    noPicture: "请选择图片或输入其地址。",
  },
  edit: {
    typing: "正在输入",
  },
