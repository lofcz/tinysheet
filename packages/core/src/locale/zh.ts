export default {
  ...
  conditionformat: {
    ...
    appliesTo: "应用于",
    applyLabel: "应用",
    averageOfRange: "所选范围的平均值",
    avgAbove: "高于",
    avgBelow: "低于",
    avgEqualAbove: "等于或高于",
    avgEqualBelow: "等于或低于",
    axisAutomatic: "自动（根据负值确定位置）",
    axisColor: "坐标轴颜色",
    axisMidpoint: "单元格中点",
    axisNone: "无（负值条形图与正值方向相同）",
    axisSetting: "坐标轴",
    barAppearance: "条形图外观",
    barDirection: "条形图方向",
    blanksOpt: "空值",
    ...
    cellValueOpt: "单元格值",
    clearRules: "清除规则",
    clearRulesSelection: "清除所选单元格的规则",
    clearRulesSheet: "清除整个工作表的规则",
    colorLabel: "颜色",
    currentSelection: "当前选择",
    dataBarStyle: "数据条",
    datesOccurringOpt: "发生日期",
    descColorScale: "渐变颜色刻度",
    descDataBar: "数据条",
    descDuplicate: "重复值",
    descFormula: "公式",
    descIconSet: "图标集",
    ...
    dirLTR: "从左到右",
    dirRTL: "从右到左",
    displayIcon: "根据以下规则显示各个图标：",
    duplicateRule: "复制规则",
    enterFormula: "请输入公式",
    enterValue: "请输入值",
    errorsOpt: "错误",
    fillLabel: "填充",
    forSelectedRange: "针对选定区域",
    formatAll: "全部设置格式：",
    formatOnlyCellsWith: "只为满足以下条件的单元格设置格式：",
    formatStyleLabel: "格式样式：",
    formatValuesRanked: "为以下排名内的值设置格式：",
    formatValuesThatAre: "为满足以下条件的值设置格式：",
    formatWhereFormula: "为符合此公式的值设置格式：",
    gradientFill: "渐变填充",
    iconLabel: "图标",
    iconSetStyle: "图标集",
    iconStyle: "图标样式",
    invalidRange: "请输入有效的区域，例如 A1:B10",
    manageRulesTitle: "条件格式规则管理器",
    maximum: "最大值",
    midpoint: "中间值",
    minimum: "最小值",
    moreRules: "其他规则...",
    ...
    operatorLabel: "运算符",
    otherwise: "其他情况",
    percentOfRange: "所选范围的百分比",
    presetCustom: "自定义格式",
    presetGreen: "绿填充色深绿色文本",
    presetLightRed: "浅红填充色深红色文本",
    presetLightRedFill: "浅红色填充",
    presetRedBorder: "红色边框",
    presetRedText: "红色文本",
    presetYellow: "黄填充色深黄色文本",
    previewLabel: "预览：",
    reverseIconOrder: "反转图标次序",
    sameAsPositive: "与正值相同",
    sampleText: "AaBbCcYyZz",
    selectRuleType: "选择规则类型：",
    showBarOnly: "仅显示数据条",
    showIconOnly: "仅显示图标",
    showRulesFor: "显示其格式规则：",
    solidBorder: "实心边框",
    solidFill: "实心填充",
    specificTextOpt: "特定文本",
    stdDevAbove: "高于平均值 {n} 个标准偏差",
    stdDevBelow: "低于平均值 {n} 个标准偏差",
    stopIfTrue: "如果为真则停止",
    thisSheet: "当前工作表",
    threeColorScale: "三色刻度",
    twoColorScale: "双色刻度",
    topLabel: "前",
    typeLabel: "类型",
    valueLabel: "值",
    valuesInRange: "选定范围中的值",
    valuesWith: "值",
    vtAutomatic: "自动",
    vtFormula: "公式",
    vtHighest: "最高值",
    ...
    isGroup_shapes: "形状",
    isGroup_indicators: "标记",
    isGroup_ratings: "等级",
    is_3Arrows: "三向箭头（彩色）",
    is_3ArrowsGray: "三向箭头（灰色）",
    is_3Flags: "三色旗",
    is_3TrafficLights1: "三色交通灯（无边框）",
    is_3TrafficLights2: "三色交通灯（有边框）",
    is_3Signs: "三标志",
    is_3Symbols: "三个符号（有圆圈）",
    is_3Symbols2: "三个符号（无圆圈）",
    is_3Stars: "3 个星形",
    is_3Triangles: "3 个三角形",
    is_4Arrows: "四向箭头（彩色）",
    is_4ArrowsGray: "四向箭头（灰色）",
    is_4RedToBlack: "红-黑渐变",
    is_4Rating: "四等级",
    is_4TrafficLights: "四色交通灯",
    is_5Arrows: "五向箭头（彩色）",
    is_5ArrowsGray: "五向箭头（灰色）",
    is_5Rating: "五等级",
    is_5Quarters: "五象限图",
    is_5Boxes: "五格",
    qt_greaterThan: "大于",
    ...
    qt_between: "介于",
    qt_equal: "等于",
    qt_textContains: "文本包含",
    qt_occurrenceDate: "发生日期",
    qt_duplicateValue: "重复值",
    qt_top10: "前 10 项",
    qt_top10_percent: "前 10%",
    qt_last10: "最后 10 项",
    qt_last10_percent: "最后 10%",
    qt_aboveAverage: "高于平均值",
    qt_belowAverage: "低于平均值",
    qd_greaterThan: "为大于以下值的单元格设置格式：",
    qd_lessThan: "为小于以下值的单元格设置格式：",
    qd_between: "为介于以下值之间的单元格设置格式：",
    qd_equal: "为等于以下值的单元格设置格式：",
    qd_textContains: "为包含以下文本的单元格设置格式：",
    qd_occurrenceDate: "为包含以下日期的单元格设置格式：",
    qd_duplicateValue: "为包含以下类型值的单元格设置格式：",
    qd_top10: "为值最大的那些单元格设置格式：",
    qd_top10_percent: "为值最大的那些单元格设置格式：",
    qd_last10: "为值最小的那些单元格设置格式：",
    qd_last10_percent: "为值最小的那些单元格设置格式：",
    qd_aboveAverage: "为高于平均值的单元格设置格式：",
    qd_belowAverage: "为低于平均值的单元格设置格式：",
  },
  insertLink: {
    linkText: "显示文本",
    linkType: "链接类型",
