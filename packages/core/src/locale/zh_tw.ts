export default {
  ...
  cellImage: {
    pictureInCell: "儲存格中的圖片",
    insertTitle: "在儲存格中插入圖片",
    placeInCell: "放置在儲存格中",
    placeOverCells: "放置在儲存格上",
    insertPicture: "在儲存格中放置圖片…",
    altText: "替代文字…",
    altTextTitle: "替代文字",
    altTextLabel: "為看不到此圖片的使用者描述圖片",
    fromFile: "此裝置…",
    fromUrl: "從網址",
    urlLabel: "圖片位址（https:// 或 data:image）",
    invalidUrl: "請輸入圖片的 https:// 位址。",
    readFailed: "無法讀取圖片。",
    picture: "圖片",
    deletePicture: "刪除圖片",
    noPicture: "請選擇圖片或輸入其位址。",
  },
  edit: {
    typing: "正在輸入",
  },
