export default {
  ...
  info: {
    ...
    sheetTabs: "Ярлыки листов",
    allSheets: "Все листы",
    scrollTabsLeft: "Прокрутить ярлыки листов влево",
    scrollTabsRight: "Прокрутить ярлыки листов вправо",
    zoomSettings: "Параметры масштаба",
    zoomLevel: "Масштаб",
    imageCrop: "Обрезать",
    imageRestore: "Восстановить исходное изображение",
  },
  currencyDetail: [
    {
      name: "Юань",
  ...
  freezen: {
    ...
    splitPanes: "Разделить",
    removeSplit: "Снять разделение",
  },
  sort: {
    asc: "По возрастанию",
    desc: "По убыванию",
  ...
  statusBar: {
    ...
    recalculating: "Вычисление ({0}%)",
    customize: "Настройка строки состояния",
    copied: "Скопировано в буфер обмена",
    clickToCopy: "Щёлкните, чтобы скопировать",
  },
  cellMenu: {
    cut: "Вырезать",
    copy: "Копировать",
    ...
    insert: "Вставить…",
    delete: "Удалить…",
    insertRowCol: "Вставить",
    deleteRowCol: "Удалить",
    ...
    editNote: "Изменить примечание",
    deleteNote: "Удалить примечание",
    showNote: "Показать или скрыть примечание",
    showAllNotes: "Показать или скрыть все примечания",
    formatCells: "Формат ячеек…",
    pickFromList: "Выбрать из раскрывающегося списка…",
    ...
    autofitRowHeight: "Автоподбор высоты строки",
    autofitColumnWidth: "Автоподбор ширины столбца",
    hide: "Скрыть",
    unhide: "Показать",
    insertTitle: "Добавление ячеек",
    deleteTitle: "Удаление ячеек",
    shiftRight: "Ячейки со сдвигом вправо",
    shiftDown: "Ячейки со сдвигом вниз",
    shiftLeft: "Ячейки со сдвигом влево",
    shiftUp: "Ячейки со сдвигом вверх",
    entireRow: "Строку",
    entireColumn: "Столбец",
    rowHeightTitle: "Высота строки",
    columnWidthTitle: "Ширина столбца",
    rowHeightLabel: "Высота строки (пикс.):",
    columnWidthLabel: "Ширина столбца (пикс.):",
    partMC: "Эта операция изменит часть объединённой ячейки.",
    noPickList: "Над этой ячейкой и под ней нет значений для выбора.",
    overLimit: "Лист не может вырасти настолько.",
    tableShift:
      "Эта операция запрещена. Операция пытается сдвинуть ячейки таблицы на листе.",
  },
  screenshot: {
  ...
  findAndReplace: {
    ...
    within: "Искать:",
    withinSheet: "На листе",
    withinWorkbook: "В книге",
    searchBy: "Просматривать:",
    byRows: "По строкам",
    byColumns: "По столбцам",
    lookIn: "Область поиска:",
    lookInFormulas: "Формулы",
    lookInValues: "Значения",
    lookInNotes: "Примечания",
    matchCase: "Учитывать регистр",
    matchEntire: "Ячейка целиком",
    findPrevBtn: "Найти предыдущее",
    optionsBtn: "Параметры",
    searchTargetFormula: "Формула",
    foundCount: "Найдено ячеек: ${count}",
    replacedCount: "Готово. Произведено замен: ${count}.",
    wildcardHint:
      "Подстановочные знаки: * любые символы, ? один символ, ~ экранирует",
    gotoReference: "Ссылка:",
    gotoSpecialBtn: "Выделить...",
    gotoInvalid: "Недопустимая ссылка.",
    gotoTitle: "Переход",
    gotoSpecialTitle: "Выделить группу ячеек",
    specialNotes: "Примечания",
    specialConstants: "Константы",
    specialFormulas: "Формулы",
    specialNumbers: "Числа",
    specialText: "Текст",
    specialLogicals: "Логические",
    specialErrors: "Ошибки",
    specialBlanks: "Пустые ячейки",
    specialCurrentRegion: "Текущая область",
    specialCurrentArray: "Текущий массив",
    specialRowDifferences: "Отличия по строкам",
    specialColumnDifferences: "Отличия по столбцам",
    specialPrecedents: "Влияющие ячейки",
    specialDependents: "Зависимые ячейки",
    specialLastCell: "Последняя ячейка",
    specialVisibleCells: "Только видимые ячейки",
    specialConditionalFormats: "Условные форматы",
    specialDataValidation: "Проверка данных",
    specialAll: "Все",
    specialSame: "Эти же",
  },
  sheetconfig: {
    ...
    moveOrCopyTitle: "Переместить или скопировать",
    beforeSheet: "Перед листом:",
    moveToEnd: "(переместить в конец)",
    createCopy: "Создать копию",
    unhideMenu: "Показать...",
    unhideTitle: "Вывод на экран скрытого листа",
    unhideSheets: "Показать лист:",
    selectAllSheets: "Выделить все листы",
    ungroupSheets: "Разгруппировать листы",
    groupLabel: "Группа",
    tabColor: "Цвет ярлычка",
    noColor: "Нет цвета",
    nameBlank: "Имя листа не может быть пустым.",
    nameTooLong: "Имя листа не должно превышать 31 символ.",
    nameInvalidChars: "Имя листа не может содержать символы: \\ / ? * [ ] :",
    nameApostrophe:
      "Имя листа не может начинаться или заканчиваться апострофом.",
    nameDuplicate: "Это имя уже занято. Выберите другое.",
    nameReserved: "«History» — зарезервированное имя.",
  },
  conditionformat: {
    ...
    averageOfRange: "среднего значения выделенного диапазона",
    avgAbove: "выше",
    avgBelow: "ниже",
    avgEqualAbove: "равно или выше",
    avgEqualBelow: "равно или ниже",
    axisAutomatic: "Автоматически (по отрицательным значениям)",
    axisColor: "Цвет оси",
    axisMidpoint: "Середина ячейки",
    axisNone: "Нет (отрицательные столбцы в том же направлении)",
    axisSetting: "Ось",
    barAppearance: "Вид столбца",
    barDirection: "Направление столбца",
    blanksOpt: "Пустые",
    borderLabel: "Граница",
    bottomLabel: "Последние",
    cellValueOpt: "Значение ячейки",
    clearRules: "Удалить правила",
    clearRulesSelection: "Удалить правила из выделенных ячеек",
    clearRulesSheet: "Удалить правила со всего листа",
    colorLabel: "Цвет",
    currentSelection: "Текущий фрагмент",
    dataBarStyle: "Гистограмма",
    datesOccurringOpt: "Даты",
    descColorScale: "Цветовая шкала",
    descDataBar: "Гистограмма",
    descDuplicate: "Повторяющиеся значения",
    descFormula: "Формула",
    descIconSet: "Набор значков",
    descUnique: "Уникальные значения",
    dirContext: "По контексту",
    dirLTR: "Слева направо",
    dirRTL: "Справа налево",
    displayIcon: "Отображать значки по правилам:",
    duplicateRule: "Копировать правило",
    enterFormula: "Введите формулу",
    enterValue: "Введите значение",
    errorsOpt: "Ошибки",
    fillLabel: "Заливка",
    forSelectedRange: "для выделенного диапазона",
    formatAll: "Форматировать все:",
    formatOnlyCellsWith: "Форматировать только ячейки, которые содержат:",
    formatStyleLabel: "Стиль формата:",
    formatValuesRanked: "Форматировать значения, входящие в:",
    formatValuesThatAre: "Форматировать значения, которые:",
    formatWhereFormula: "Форматировать значения, для которых формула истинна:",
    gradientFill: "Градиентная заливка",
    iconLabel: "Значок",
    iconSetStyle: "Наборы значков",
    iconStyle: "Стиль значков",
    invalidRange: "Введите допустимый диапазон, например A1:B10",
    manageRulesTitle: "Диспетчер правил условного форматирования",
    maximum: "Максимум",
    midpoint: "Середина",
    minimum: "Минимум",
    moreRules: "Другие правила...",
    moveDown: "Вниз (ниже приоритет)",
    moveUp: "Вверх (выше приоритет)",
    negativeBarColor: "Цвет отрицательного столбца",
    noBlanksOpt: "Непустые",
    noBorder: "Без границы",
    noErrorsOpt: "Без ошибок",
    noFormatSet: "Формат не задан",
    noRules: "Нет правил условного форматирования",
    numberFormatLabel: "Числовой формат",
    operatorLabel: "Оператор",
    otherwise: "в остальных случаях",
    percentOfRange: "% выделенного диапазона",
    presetCustom: "Пользовательский формат",
    presetGreen: "Зелёная заливка и тёмно-зелёный текст",
    presetLightRed: "Светло-красная заливка и тёмно-красный текст",
    presetLightRedFill: "Светло-красная заливка",
    presetRedBorder: "Красная граница",
    presetRedText: "Красный текст",
    presetYellow: "Жёлтая заливка и тёмно-жёлтый текст",
    previewLabel: "Образец:",
    reverseIconOrder: "Обратный порядок значков",
    sameAsPositive: "Как у положительного",
    sampleText: "AaBbCcYyZz",
    selectRuleType: "Выберите тип правила:",
    showBarOnly: "Показывать только столбец",
    showIconOnly: "Показывать только значок",
    showRulesFor: "Показать правила форматирования для:",
    solidBorder: "Сплошная граница",
    solidFill: "Сплошная заливка",
    specificTextOpt: "Текст",
    stdDevAbove: "на {n} ст. откл. выше",
    stdDevBelow: "на {n} ст. откл. ниже",
    stopIfTrue: "Остановить, если истина",
    thisSheet: "Этот лист",
    threeColorScale: "Трёхцветная шкала",
    twoColorScale: "Двухцветная шкала",
    topLabel: "Первые",
    typeLabel: "Тип",
    valueLabel: "Значение",
    valuesInRange: "значения в выделенном диапазоне",
    valuesWith: "значения",
    vtAutomatic: "Автоматически",
    vtFormula: "Формула",
    vtHighest: "Наибольшее значение",
    vtLowest: "Наименьшее значение",
    vtNumber: "Число",
    vtPercent: "Процент",
    vtPercentile: "Процентиль",
    whenValueIs: "когда значение",
    withLabel: "формат",
    ...
    opBeginsWith: "начинается с",
    opBetween: "между",
    opContaining: "содержит",
    opEndsWith: "заканчивается на",
    opEqual: "равно",
    opGreater: "больше",
    opGreaterEq: "больше или равно",
    opLess: "меньше",
    opLessEq: "меньше или равно",
    opNotBetween: "вне",
    opNotContaining: "не содержит",
    opNotEqual: "не равно",
    dp_yesterday: "Вчера",
    dp_today: "Сегодня",
    dp_tomorrow: "Завтра",
    dp_last7Days: "За последние 7 дней",
    dp_lastWeek: "На прошлой неделе",
    dp_thisWeek: "На этой неделе",
    dp_nextWeek: "На следующей неделе",
    dp_lastMonth: "В прошлом месяце",
    dp_thisMonth: "В этом месяце",
    dp_nextMonth: "В следующем месяце",
    isGroup_directional: "Направления",
    isGroup_shapes: "Фигуры",
    isGroup_indicators: "Индикаторы",
    isGroup_ratings: "Оценки",
    is_3Arrows: "3 стрелки (цветные)",
    is_3ArrowsGray: "3 стрелки (серые)",
    is_3Flags: "3 флажка",
    is_3TrafficLights1: "3 светофора (без обода)",
    is_3TrafficLights2: "3 светофора (с ободом)",
    is_3Signs: "3 знака",
    is_3Symbols: "3 символа (в кругах)",
    is_3Symbols2: "3 символа (без кругов)",
    is_3Stars: "3 звезды",
    is_3Triangles: "3 треугольника",
    is_4Arrows: "4 стрелки (цветные)",
    is_4ArrowsGray: "4 стрелки (серые)",
    is_4RedToBlack: "От красного к чёрному",
    is_4Rating: "4 оценки",
    is_4TrafficLights: "4 светофора",
    is_5Arrows: "5 стрелок (цветные)",
    is_5ArrowsGray: "5 стрелок (серые)",
    is_5Rating: "5 оценок",
    is_5Quarters: "5 четвертей",
    is_5Boxes: "5 квадратов",
    qt_greaterThan: "Больше",
    qt_lessThan: "Меньше",
    qt_between: "Между",
    qt_equal: "Равно",
    qt_textContains: "Текст содержит",
    qt_occurrenceDate: "Дата",
    qt_duplicateValue: "Повторяющиеся значения",
    qt_top10: "Первые 10 элементов",
    qt_top10_percent: "Первые 10%",
    qt_last10: "Последние 10 элементов",
    qt_last10_percent: "Последние 10%",
    qt_aboveAverage: "Выше среднего",
    qt_belowAverage: "Ниже среднего",
    qd_greaterThan: "Форматировать ячейки, которые БОЛЬШЕ:",
    qd_lessThan: "Форматировать ячейки, которые МЕНЬШЕ:",
    qd_between: "Форматировать ячейки, которые МЕЖДУ:",
    qd_equal: "Форматировать ячейки, которые РАВНЫ:",
    qd_textContains: "Форматировать ячейки, содержащие текст:",
    qd_occurrenceDate: "Форматировать ячейки, содержащие дату:",
    qd_duplicateValue: "Форматировать ячейки, которые содержат:",
    qd_top10: "Форматировать ПЕРВЫЕ ячейки:",
    qd_top10_percent: "Форматировать ПЕРВЫЕ ячейки:",
    qd_last10: "Форматировать ПОСЛЕДНИЕ ячейки:",
    qd_last10_percent: "Форматировать ПОСЛЕДНИЕ ячейки:",
    qd_aboveAverage: "Форматировать ячейки ВЫШЕ СРЕДНЕГО:",
    qd_belowAverage: "Форматировать ячейки НИЖЕ СРЕДНЕГО:",
  },
  insertLink: {
  ...
  definedNames: {
    ...
    nameBox: "Поле имени",
    nameBoxList: "Определённые имена",
    newName: "Создать…",
    editName: "Изменить…",
    deleteName: "Удалить",
    filterPlaceholder: "Фильтр имён",
    filterAll: "Все имена",
    filterWorkbook: "Имена в области книги",
    filterSheet: "Имена в области листа",
    filterErrors: "Имена с ошибками",
    createFromSelection: "Создать из выделенного…",
    createFromSelectionTitle: "Создать имена из значений:",
    topRow: "в строке выше",
    leftColumn: "в столбце слева",
    bottomRow: "в строке ниже",
    rightColumn: "в столбце справа",
    columnName: "Имя",
    columnValue: "Значение",
    columnRefersTo: "Диапазон",
    columnScope: "Область",
    columnComment: "Примечание",
    scopeWorkbook: "Книга",
    newNameTitle: "Создание имени",
    editNameTitle: "Изменение имени",
    name: "Имя:",
    scope: "Область:",
    comment: "Примечание:",
    refersTo: "Диапазон:",
    empty: "Имена ещё не определены.",
    noMatch: "Нет имён, соответствующих фильтру.",
    deleteConfirm: "Удалить выбранное имя?",
    namesCreated: "Созданы имена:",
    invalidReference: "Ссылка или имя недопустимы.",
    errorEmpty: "Введите имя.",
    errorTooLong: "Имя может содержать не более 255 символов.",
    errorInvalidChars:
      "Имя должно начинаться с буквы, знака подчёркивания или обратной косой черты и содержать только буквы, цифры, точки и знаки подчёркивания.",
    errorCellReference:
      "Имя не может совпадать со ссылкой на ячейку, например A1 или R1C1.",
    errorReserved: "ИСТИНА и ЛОЖЬ нельзя использовать в качестве имён.",
    errorDuplicate: "Такое имя уже существует.",
    errorEmptyDefinition: "Укажите, на что ссылается имя.",
  },
  tables: {
    formatAsTable: "Форматировать как таблицу",
    tableStyles: "Стили таблиц",
    createTable: "Создание таблицы",
    tableRange: "Укажите расположение данных таблицы",
    hasHeaders: "Таблица с заголовками",
    tableDesign: "Конструктор таблиц…",
    tableDesignTitle: "Конструктор таблиц",
    tableName: "Имя таблицы:",
    tableRangeLabel: "Диапазон:",
    options: "Параметры стилей таблиц",
    headerRow: "Строка заголовка",
    totalRow: "Строка итогов",
    bandedRows: "Чередующиеся строки",
    bandedColumns: "Чередующиеся столбцы",
    firstColumn: "Первый столбец",
    lastColumn: "Последний столбец",
    totals: "Функции строки итогов",
    convertToRange: "Преобразовать в диапазон",
    convertConfirm: "Преобразовать таблицу в обычный диапазон?",
    resize: "Размер таблицы",
    fnNone: "Нет",
    fnSum: "Сумма",
    fnAverage: "Среднее",
    fnCount: "Количество",
    fnCountNums: "Количество чисел",
    fnMax: "Максимум",
    fnMin: "Минимум",
    fnStdDev: "Стандартное отклонение",
    fnVar: "Дисперсия",
    errorOverlap: "Таблица не может перекрывать другую таблицу.",
    errorMerged: "Таблица не может содержать объединённые ячейки.",
    errorInvalidRange: "Недопустимая ссылка.",
    errorNoRoom: "Строка под таблицей должна быть пустой.",
    errorInvalidName: "Недопустимое имя таблицы.",
    errorDuplicateName: "Таблица или имя с таким именем уже существует.",
    errorNotFound: "Таблица больше не существует.",
    styleBlue: "Синий",
    styleOrange: "Оранжевый",
    styleGray: "Серый",
    styleGold: "Золотой",
    styleLightBlue: "Голубой",
    styleGreen: "Зелёный",
    styleBlack: "Чёрный",
    stylePurple: "Фиолетовый",
  },
  editMode: {
    ready: "Готово",
    enter: "Ввод",
  ...
  spill: {
    notBlank: "Диапазон переноса не пуст",
    notBlankDetail:
      "Результаты формулы нельзя перенести, так как ячейки на пути не пусты.",
    selectObstructing: "Выделить мешающие ячейки",
  },
  pasteSpecial: {
    ...
    operation: "Операция",
    all: "Всё",
    allUsingSourceColumnWidths: "Всё с исходной шириной столбцов",
    formulas: "Формулы",
    values: "Значения",
    formats: "Форматы",
    comments: "Примечания",
    validation: "Условия на значения",
    allExceptBorders: "Без рамки",
    columnWidths: "Ширины столбцов",
    formulasAndNumberFormats: "Формулы и форматы чисел",
    valuesAndNumberFormats: "Значения и форматы чисел",
    none: "Нет",
    add: "Сложить",
    subtract: "Вычесть",
    multiply: "Умножить",
    divide: "Разделить",
    skipBlanks: "Пропускать пустые ячейки",
    transpose: "Транспонировать",
    pasteLink: "Вставить связь",
    ok: "ОК",
    cancel: "Отмена",
  },
  drag: {
  ...
  formatCells: {
    ...
    descriptions: {
      ...
      number:
        "Числовой формат является наиболее общим способом представления чисел. Для вывода денежных значений используются также форматы «Денежный» и «Финансовый».",
      currency:
        "Формат «Денежный» используется для отображения денежных величин. Для выравнивания десятичных разделителей используйте формат «Финансовый».",
      accounting:
        "Формат «Финансовый» выравнивает денежные символы и десятичные разделители в столбце.",
      date: "Форматы даты служат для отображения дат и времени, представленных числами, в виде дат.",
      time: "Форматы времени служат для отображения дат и времени, представленных числами, в виде времени.",
      percentage:
        "В процентном формате значение ячейки умножается на 100, а результат отображается со знаком процента.",
      fraction: "Дробный формат отображает числа в виде дробей.",
      scientific:
        "Экспоненциальный формат отображает числа в экспоненциальной записи.",
      text: "Значения в текстовом формате отображаются точно так же, как вводятся. Они обрабатываются как строки вне зависимости от их содержания.",
      special: "Дополнительные форматы используются для списков и баз данных.",
      custom:
    ...
    useThousands: "Разделитель групп разрядов (,)",
    negativeNumbers: "Отрицательные числа",
    symbol: "Обозначение",
    none: "Нет",
    type: "Тип",
    fractionTypes: [
      "Простыми дробями (1/4)",
      "Дробями до двух цифр (21/25)",
      "Дробями до трёх цифр (312/943)",
      "Половинными долями (1/2)",
      "Четвертыми долями (2/4)",
      "Восьмыми долями (4/8)",
      "Шестнадцатыми долями (8/16)",
      "Десятыми долями (3/10)",
      "Сотыми долями (30/100)",
    ],
    specialTypes: [
      "Почтовый индекс",
      "Индекс + 4",
    ...
    invalidFormat: "Этот числовой формат недопустим.",
    textAlignment: "Выравнивание",
    horizontal: "По горизонтали",
    vertical: "По вертикали",
    alignGeneral: "По значению",
    alignLeft: "По левому краю (отступ)",
    alignCenter: "По центру",
    alignRight: "По правому краю (отступ)",
    alignTop: "По верхнему краю",
    alignMiddle: "По центру",
    alignBottom: "По нижнему краю",
    indent: "Отступ",
    textControl: "Отображение",
    wrapText: "Переносить текст",
    shrinkToFit: "Автоподбор ширины",
    ...
    underlineSingle: "Одинарное",
    underlineDouble: "Двойное",
    color: "Цвет",
    automatic: "Авто",
    effects: "Видоизменение",
    ...
    border: "Отдельные",
    borderHint:
      "Выберите тип и цвет линии, затем щёлкните набор, кнопку или образец, чтобы применить их.",
    borderTop: "Верхняя граница",
    borderBottom: "Нижняя граница",
    borderLeft: "Левая граница",
    borderRight: "Правая граница",
    borderInsideH: "Внутренняя горизонтальная граница",
    borderInsideV: "Внутренняя вертикальная граница",
    backgroundColor: "Цвет фона",
    noColor: "Нет цвета",
    moreColors: "Другие цвета...",
    themeColors: "Цвета темы",
    standardColors: "Стандартные цвета",
    locked: "Защищаемая ячейка",
    hidden: "Скрыть формулы",
    protectionHint:
      "Защита ячеек и скрытие формул действуют только после защиты листа.",
  },
  numberFormatMenu: {
    general: "Общий",
    number: "Числовой",
    currency: "Денежный",
    accounting: "Финансовый",
    shortDate: "Краткая дата",
    longDate: "Длинный формат даты",
    time: "Время",
    percentage: "Процентный",
    fraction: "Дробный",
    scientific: "Экспоненциальный",
    text: "Текстовый",
    custom: "(все форматы)",
    moreFormats: "Другие числовые форматы...",
    noSpecificFormat: "Нет определённого формата",
  },
  cellStyles: {
    title: "Стили ячеек",
    groups: {
      goodBad: "Хороший, плохой и нейтральный",
      data: "Данные и модель",
      titles: "Названия и заголовки",
      number: "Числовой формат",
    },
    names: {
      normal: "Обычный",
      bad: "Плохой",
      ...
      checkCell: "Контрольная ячейка",
      explanatory: "Пояснение",
      input: "Ввод",
      linkedCell: "Связанная ячейка",
      note: "Примечание",
      output: "Вывод",
