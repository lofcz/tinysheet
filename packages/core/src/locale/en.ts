...
export default {
  ...
  cellMenu: {
    ...
    showAllNotes: "Show/Hide All Notes",
    formatCells: "Format Cells…",
    pickFromList: "Pick From Drop-down List…",
  ...
  findAndReplace: {
    ...
    findPrevBtn: "Find Previous",
    optionsBtn: "Options",
    searchTargetFormula: "Formula",
    foundCount: "${count} cell(s) found",
    replacedCount: "All done. We made ${count} replacements.",
    wildcardHint: "Wildcards: * any characters, ? one character, ~ escapes",
    gotoReference: "Reference:",
    gotoSpecialBtn: "Special...",
    gotoInvalid: "Reference isn't valid.",
    gotoTitle: "Go To",
    gotoSpecialTitle: "Go To Special",
    specialNotes: "Notes",
    specialConstants: "Constants",
    specialFormulas: "Formulas",
    specialNumbers: "Numbers",
    specialText: "Text",
    specialLogicals: "Logicals",
    specialErrors: "Errors",
    specialBlanks: "Blanks",
    specialCurrentRegion: "Current region",
    specialCurrentArray: "Current array",
    specialRowDifferences: "Row differences",
    specialColumnDifferences: "Column differences",
    specialPrecedents: "Precedents",
    specialDependents: "Dependents",
    specialLastCell: "Last cell",
    specialVisibleCells: "Visible cells only",
    specialConditionalFormats: "Conditional formats",
    specialDataValidation: "Data validation",
    specialAll: "All",
    specialSame: "Same",
  },
  sheetconfig: {
    ...
    moveOrCopyTitle: "Move or Copy",
    beforeSheet: "Before sheet:",
    moveToEnd: "(move to end)",
    createCopy: "Create a copy",
    unhideMenu: "Unhide...",
    unhideTitle: "Unhide",
    unhideSheets: "Unhide sheet:",
    selectAllSheets: "Select All Sheets",
    ungroupSheets: "Ungroup Sheets",
    groupLabel: "Group",
    tabColor: "Tab Color",
    noColor: "No Color",
    nameBlank: "The sheet name can't be blank.",
    nameTooLong: "The sheet name must be 31 characters or fewer.",
    nameInvalidChars:
      "The sheet name can't contain any of these characters: \\ / ? * [ ] :",
    nameApostrophe: "The sheet name can't begin or end with an apostrophe.",
    nameDuplicate: "That name is already taken. Try a different one.",
    nameReserved: '"History" is a reserved name.',
  },
  conditionformat: {
  ...
  spill: {
    notBlank: "Spill range isn't blank",
    notBlankDetail:
      "The formula's results can't spill because cells in the way aren't empty.",
    selectObstructing: "Select Obstructing Cells",
  },
  pasteSpecial: {
    title: "Paste Special",
    paste: "Paste",
  ...
  formatCells: {
    ...
    descriptions: {
      ...
      number:
        "Number is used for general display of numbers. Currency and Accounting offer specialized formatting for monetary values.",
      currency:
      ...
      fraction: "Fraction formats display numbers as fractions.",
    ...
    invalidFormat: "This number format is not valid.",
    textAlignment: "Text alignment",
    horizontal: "Horizontal",
    vertical: "Vertical",
    alignGeneral: "General",
    alignLeft: "Left (Indent)",
    alignCenter: "Center",
    alignRight: "Right (Indent)",
    alignTop: "Top",
    alignMiddle: "Center",
    alignBottom: "Bottom",
    indent: "Indent",
    ...
    border: "Border",
    borderHint:
      "Pick a line style and color, then click a preset, a button or the preview to apply it.",
    borderTop: "Top border",
    borderBottom: "Bottom border",
    borderLeft: "Left border",
    borderRight: "Right border",
    borderInsideH: "Inside horizontal border",
    borderInsideV: "Inside vertical border",
  ...
  numberFormatMenu: {
    ...
    text: "Text",
    custom: "Custom",
    moreFormats: "More Number Formats...",
    noSpecificFormat: "No specific format",
  },
  cellStyles: {
    title: "Cell Styles",
    groups: {
      goodBad: "Good, Bad and Neutral",
      data: "Data and Model",
      titles: "Titles and Headings",
  ...
  shape: {
    ...
    shape: "Shape",
    drawHint: "Drag on the sheet to draw. Esc cancels.",
    lines: "Lines",
    basic: "Basic shapes",
    arrows: "Block arrows",
    callouts: "Callouts",
    ...
    dashDash: "Dash",
    dashDot: "Round dot",
    dashDashDot: "Dash dot",
    dashLong: "Long dash",
    beginArrow: "Begin arrow",
    endArrow: "End arrow",
    arrowNone: "None",
    arrowTriangle: "Arrow",
    effects: "Effects",
    ...
    ungroup: "Ungroup",
    alignObjects: "Align",
    alignObjectsLeft: "Align left",
    alignObjectsCenter: "Align center",
    alignObjectsRight: "Align right",
    alignObjectsTop: "Align top",
    alignObjectsMiddle: "Align middle",
    alignObjectsBottom: "Align bottom",
  ...
  cellImage: {
    pictureInCell: "Picture in Cell",
    insertTitle: "Insert Picture in Cell",
    placeInCell: "Place in Cell",
    placeOverCells: "Place over Cells",
    insertPicture: "Place Picture in Cell…",
    altText: "Alt Text…",
    altTextTitle: "Alt Text",
    altTextLabel: "Describe this picture for people who can't see it",
    fromFile: "This Device…",
    fromUrl: "From a web address",
    urlLabel: "Picture address (https:// or data:image)",
    invalidUrl: "Enter an https:// address of a picture.",
    readFailed: "The picture could not be read.",
    picture: "Picture",
    deletePicture: "Delete Picture",
    noPicture: "Choose a picture or enter its address.",
  },
  edit: {
    typing: "typing",
  },
