export default {
  ...
  toolbar: {
    ...
    "percentage-format": "Formato de porcentaje",
    "number-decrease": "Disminuir decimales",
    "number-increase": "Aumentar decimales",
    "border-all": "Todos los bordes",
    "merge-all": "Combinar todas las celdas",
    "strike-through": "Tachado (Alt+Shift+5)",
    "align-left": "Alinear a la izquierda",
    "align-center": "Centrar horizontalmente",
    "align-right": "Alinear a la derecha",
    "align-top": "Alinear en la parte superior",
    "align-mid": "Centrar verticalmente",
    "align-bottom": "Alinear en la parte inferior",
  ...
  info: {
    ...
    scrollTabsLeft: "Desplazar las pestañas de hojas a la izquierda",
    scrollTabsRight: "Desplazar las pestañas de hojas a la derecha",
    zoomSettings: "Configuración del zoom",
    zoomLevel: "Nivel de zoom",
    imageCrop: "Recortar",
    imageRestore: "Restaurar la imagen original",
  },
  currencyDetail: {
    RMB: "RMB",
    USdollar: "Dólar US",
  ...
  border: {
    ...
    borderOutside: "Bordes externos",
    borderInside: "Bordes internos",
    borderHorizontal: "Bordes horizontales",
    borderVertical: "Bordes verticales",
    borderColor: "Color de línea",
    borderSize: "Grosor de línea",
  ...
  cellMenu: {
    ...
    insert: "Insertar…",
    delete: "Eliminar…",
    insertRowCol: "Insertar",
    deleteRowCol: "Eliminar",
    ...
    clearFilter: "Quitar filtro",
    insertNote: "Insertar comentario",
    editNote: "Modificar comentario",
    deleteNote: "Eliminar comentario",
    showNote: "Mostrar u ocultar comentario",
    showAllNotes: "Mostrar u ocultar todos los comentarios",
    formatCells: "Formato de celdas…",
    pickFromList: "Elegir de la lista desplegable…",
    defineName: "Definir nombre…",
    link: "Vínculo…",
    editLink: "Modificar vínculo…",
  ...
  findAndReplace: {
    ...
    within: "Dentro de:",
    withinSheet: "Hoja",
    withinWorkbook: "Libro",
    searchBy: "Buscar:",
    byRows: "Por filas",
    byColumns: "Por columnas",
    lookIn: "Buscar en:",
    lookInFormulas: "Fórmulas",
    lookInValues: "Valores",
    lookInNotes: "Notas",
    matchCase: "Coincidir mayúsculas y minúsculas",
    matchEntire: "Coincidir con el contenido de toda la celda",
    findPrevBtn: "Buscar anterior",
    optionsBtn: "Opciones",
    searchTargetFormula: "Fórmula",
    foundCount: "${count} celda(s) encontrada(s)",
    replacedCount: "Listo. Se realizaron ${count} reemplazos.",
    wildcardHint: "Comodines: * cualquier texto, ? un carácter, ~ escapa",
    gotoReference: "Referencia:",
    gotoSpecialBtn: "Especial...",
    gotoInvalid: "La referencia no es válida.",
    gotoTitle: "Ir a",
    gotoSpecialTitle: "Ir a Especial",
    specialNotes: "Notas",
    specialConstants: "Constantes",
    specialFormulas: "Fórmulas",
    specialNumbers: "Números",
    specialText: "Texto",
    specialLogicals: "Lógicos",
    specialErrors: "Errores",
    specialBlanks: "Celdas en blanco",
    specialCurrentRegion: "Región actual",
    specialCurrentArray: "Matriz actual",
    specialRowDifferences: "Diferencias entre filas",
    specialColumnDifferences: "Diferencias entre columnas",
    specialPrecedents: "Celdas precedentes",
    specialDependents: "Celdas dependientes",
    specialLastCell: "Última celda",
    specialVisibleCells: "Solo celdas visibles",
    specialConditionalFormats: "Formatos condicionales",
    specialDataValidation: "Validación de datos",
    specialAll: "Todos",
    specialSame: "Iguales",
  },
  sheetconfig: {
    ...
    moveOrCopyTitle: "Mover o copiar",
    beforeSheet: "Antes de la hoja:",
    moveToEnd: "(mover al final)",
    createCopy: "Crear una copia",
    unhideMenu: "Mostrar...",
    unhideTitle: "Mostrar",
    unhideSheets: "Mostrar hoja:",
    selectAllSheets: "Seleccionar todas las hojas",
    ungroupSheets: "Desagrupar hojas",
    groupLabel: "Grupo",
    tabColor: "Color de pestaña",
    noColor: "Sin color",
    nameBlank: "El nombre de la hoja no puede estar en blanco.",
    nameTooLong: "El nombre de la hoja debe tener 31 caracteres o menos.",
    nameInvalidChars: "El nombre de la hoja no puede contener: \\ / ? * [ ] :",
    nameApostrophe:
      "El nombre de la hoja no puede empezar ni terminar con un apóstrofo.",
    nameDuplicate: "Ese nombre ya está en uso. Pruebe con otro.",
    nameReserved: '"History" es un nombre reservado.',
  },
  conditionformat: {
    ...
    applyLabel: "Aplicar",
    averageOfRange: "el promedio del rango seleccionado",
    avgAbove: "por encima de",
    avgBelow: "por debajo de",
    avgEqualAbove: "igual o por encima de",
    avgEqualBelow: "igual o por debajo de",
    axisAutomatic: "Automático (según los valores negativos)",
    axisColor: "Color del eje",
    axisMidpoint: "Punto medio de la celda",
    axisNone: "Ninguno (barras negativas en la misma dirección)",
    axisSetting: "Eje",
    barAppearance: "Apariencia de la barra",
    barDirection: "Dirección de la barra",
    blanksOpt: "Celdas en blanco",
    borderLabel: "Borde",
    bottomLabel: "Inferior",
    cellValueOpt: "Valor de la celda",
    clearRules: "Borrar reglas",
    clearRulesSelection: "Borrar reglas de las celdas seleccionadas",
    clearRulesSheet: "Borrar reglas de toda la hoja",
    colorLabel: "Color",
    currentSelection: "Selección actual",
    dataBarStyle: "Barra de datos",
    datesOccurringOpt: "Fechas",
    descColorScale: "Escala de color graduada",
    descDataBar: "Barra de datos",
    descDuplicate: "Valores duplicados",
    descFormula: "Fórmula",
    descIconSet: "Conjunto de iconos",
    descUnique: "Valores únicos",
    dirContext: "Contexto",
    dirLTR: "De izquierda a derecha",
    dirRTL: "De derecha a izquierda",
    displayIcon: "Mostrar cada icono según estas reglas:",
    duplicateRule: "Duplicar regla",
    enterFormula: "Introduzca una fórmula",
    enterValue: "Introduzca un valor",
    errorsOpt: "Errores",
    fillLabel: "Relleno",
    forSelectedRange: "para el rango seleccionado",
    formatAll: "Dar formato a todos:",
    formatOnlyCellsWith: "Dar formato solo a las celdas con:",
    formatStyleLabel: "Estilo de formato:",
    formatValuesRanked: "Dar formato a los valores clasificados en:",
    formatValuesThatAre: "Dar formato a los valores que estén:",
    formatWhereFormula:
      "Dar formato a los valores donde esta fórmula sea verdadera:",
    gradientFill: "Relleno degradado",
    iconLabel: "Icono",
    iconSetStyle: "Conjuntos de iconos",
    iconStyle: "Estilo de icono",
    invalidRange: "Introduzca un rango válido, p. ej. A1:B10",
    manageRulesTitle: "Administrador de reglas de formato condicional",
    maximum: "Máximo",
    ...
    negativeBarColor: "Color de barra negativa",
    noBlanksOpt: "Sin celdas en blanco",
    noBorder: "Sin borde",
    noErrorsOpt: "Sin errores",
    noFormatSet: "Sin formato",
    noRules: "No hay reglas de formato condicional",
    numberFormatLabel: "Formato de número",
    operatorLabel: "Operador",
    otherwise: "en otro caso",
    percentOfRange: "% del rango seleccionado",
    presetCustom: "Formato personalizado",
    presetGreen: "Relleno verde con texto verde oscuro",
    presetLightRed: "Relleno rojo claro con texto rojo oscuro",
    presetLightRedFill: "Relleno rojo claro",
    presetRedBorder: "Borde rojo",
    presetRedText: "Texto rojo",
    presetYellow: "Relleno amarillo con texto amarillo oscuro",
    previewLabel: "Vista previa:",
    reverseIconOrder: "Invertir orden de iconos",
    sameAsPositive: "Igual que la barra positiva",
    sampleText: "AaBbCcYyZz",
    selectRuleType: "Seleccione un tipo de regla:",
    showBarOnly: "Mostrar solo la barra",
    showIconOnly: "Mostrar solo el icono",
    showRulesFor: "Mostrar reglas de formato para:",
    solidBorder: "Borde sólido",
    solidFill: "Relleno sólido",
    specificTextOpt: "Texto específico",
    stdDevAbove: "{n} desv. est. por encima",
    stdDevBelow: "{n} desv. est. por debajo",
    stopIfTrue: "Detener si es verdad",
    thisSheet: "Esta hoja",
    threeColorScale: "Escala de 3 colores",
    twoColorScale: "Escala de 2 colores",
    topLabel: "Superior",
    typeLabel: "Tipo",
    valueLabel: "Valor",
    valuesInRange: "valores en el rango seleccionado",
    valuesWith: "valores",
    vtAutomatic: "Automático",
    vtFormula: "Fórmula",
    vtHighest: "Valor más alto",
    vtLowest: "Valor más bajo",
    vtNumber: "Número",
    vtPercent: "Porcentual",
    vtPercentile: "Percentil",
    ...
    opBeginsWith: "que comienza por",
    opBetween: "entre",
    opContaining: "que contiene",
    opEndsWith: "que termina en",
    opEqual: "igual a",
    opGreater: "mayor que",
    opGreaterEq: "mayor o igual que",
    opLess: "menor que",
    opLessEq: "menor o igual que",
    opNotBetween: "no está entre",
    opNotContaining: "que no contiene",
    opNotEqual: "distinto de",
    dp_yesterday: "Ayer",
    dp_today: "Hoy",
    dp_tomorrow: "Mañana",
    dp_last7Days: "En los últimos 7 días",
    dp_lastWeek: "Semana pasada",
    dp_thisWeek: "Esta semana",
    dp_nextWeek: "Semana próxima",
    dp_lastMonth: "Mes pasado",
    dp_thisMonth: "Este mes",
    dp_nextMonth: "Mes próximo",
    isGroup_directional: "Direccional",
    isGroup_shapes: "Formas",
    isGroup_indicators: "Indicadores",
    isGroup_ratings: "Valoraciones",
    is_3Arrows: "3 flechas (de color)",
    is_3ArrowsGray: "3 flechas (gris)",
    is_3Flags: "3 banderas",
    is_3TrafficLights1: "3 semáforos (sin marco)",
    is_3TrafficLights2: "3 semáforos (con marco)",
    is_3Signs: "3 señales",
    is_3Symbols: "3 símbolos (en círculo)",
    is_3Symbols2: "3 símbolos (sin círculo)",
    is_3Stars: "3 estrellas",
    is_3Triangles: "3 triángulos",
    is_4Arrows: "4 flechas (de color)",
    is_4ArrowsGray: "4 flechas (gris)",
    is_4RedToBlack: "De rojo a negro",
    is_4Rating: "4 clasificaciones",
    is_4TrafficLights: "4 semáforos",
    is_5Arrows: "5 flechas (de color)",
    is_5ArrowsGray: "5 flechas (gris)",
    is_5Rating: "5 clasificaciones",
    is_5Quarters: "5 cuartos",
    is_5Boxes: "5 cuadros",
    qt_greaterThan: "Mayor que",
    qt_lessThan: "Menor que",
    qt_between: "Entre",
    qt_equal: "Igual a",
    qt_textContains: "Texto que contiene",
    qt_occurrenceDate: "Una fecha",
    qt_duplicateValue: "Valores duplicados",
    qt_top10: "10 superiores",
    qt_top10_percent: "10% superior",
    qt_last10: "10 inferiores",
    qt_last10_percent: "10% inferior",
    qt_aboveAverage: "Por encima del promedio",
    qt_belowAverage: "Por debajo del promedio",
    qd_greaterThan: "Dar formato a celdas MAYORES QUE:",
    qd_lessThan: "Dar formato a celdas MENORES QUE:",
    qd_between: "Dar formato a celdas ENTRE:",
    qd_equal: "Dar formato a celdas IGUALES A:",
    qd_textContains: "Dar formato a celdas que contienen el texto:",
    qd_occurrenceDate: "Dar formato a celdas que contienen una fecha:",
    qd_duplicateValue: "Dar formato a celdas que contienen:",
    qd_top10: "Dar formato a celdas que se clasifican en los SUPERIORES:",
    qd_top10_percent:
      "Dar formato a celdas que se clasifican en los SUPERIORES:",
    qd_last10: "Dar formato a celdas que se clasifican en los INFERIORES:",
    qd_last10_percent:
      "Dar formato a celdas que se clasifican en los INFERIORES:",
    qd_aboveAverage: "Dar formato a celdas POR ENCIMA DEL PROMEDIO:",
    qd_belowAverage: "Dar formato a celdas POR DEBAJO DEL PROMEDIO:",
  },
  insertLink: {
    linkText: "Texto",
    linkType: "Tipo de vínculo",
    linkAddress: "Dirección del vínculo",
    linkSheet: "Hoja",
    linkCell: "Rango de celdas",
    linkTooltip: "Información en pantalla",
    selectCellRange: "Seleccionar rango de celdas",
    cellRangePlaceholder: "Seleccione las celdas con el cursor o escríbalas",
    placeholder1: "Escriba la dirección web del vínculo",
    placeholder2: "Escriba la celda de referencia, por ejemplo A1",
    placeholder3: "Escriba el texto de la información en pantalla",
    tooltipInfo1: "Escriba un vínculo válido",
    invalidCellRangeTip:
      "Escriba un rango de celdas correcto, como Hoja1!A1:C8",
    openLink: "Abrir vínculo",
  ...
  definedNames: {
    ...
    nameBoxList: "Nombres definidos",
    newName: "Nuevo…",
    editName: "Editar…",
    deleteName: "Eliminar",
    filterPlaceholder: "Filtrar nombres",
    filterAll: "Todos los nombres",
    filterWorkbook: "Nombres en el ámbito del libro",
    filterSheet: "Nombres en el ámbito de la hoja",
    filterErrors: "Nombres con errores",
    createFromSelection: "Crear desde la selección…",
    createFromSelectionTitle: "Crear nombres a partir de los valores de:",
    ...
    columnName: "Nombre",
    columnValue: "Valor",
    columnRefersTo: "Se refiere a",
    columnScope: "Ámbito",
    columnComment: "Comentario",
    scopeWorkbook: "Libro",
    newNameTitle: "Nombre nuevo",
    editNameTitle: "Editar nombre",
    name: "Nombre:",
    scope: "Ámbito:",
    comment: "Comentario:",
    refersTo: "Se refiere a:",
    empty: "Todavía no hay nombres definidos.",
    noMatch: "Ningún nombre coincide con el filtro.",
    deleteConfirm: "¿Desea eliminar el nombre seleccionado?",
    namesCreated: "Nombres creados:",
    invalidReference: "La referencia o el nombre no son válidos.",
    errorEmpty: "Escriba un nombre.",
    errorTooLong: "Un nombre puede tener como máximo 255 caracteres.",
    errorInvalidChars:
      "Un nombre debe comenzar por una letra, un guion bajo o una barra invertida, y contener solo letras, números, puntos y guiones bajos.",
    errorCellReference:
      "Un nombre no puede parecerse a una referencia de celda, como A1 o R1C1.",
    errorReserved: "VERDADERO y FALSO no se pueden usar como nombres.",
    errorDuplicate: "Este nombre ya existe.",
    errorEmptyDefinition: "Escriba a qué se refiere el nombre.",
  },
  tables: {
    formatAsTable: "Dar formato como tabla",
    tableStyles: "Estilos de tabla",
    createTable: "Crear tabla",
    tableRange: "¿Dónde están los datos de la tabla?",
    hasHeaders: "La tabla tiene encabezados",
    tableDesign: "Diseño de tabla…",
    tableDesignTitle: "Diseño de tabla",
    tableName: "Nombre de la tabla:",
    tableRangeLabel: "Rango:",
    options: "Opciones de estilo de tabla",
    headerRow: "Fila de encabezado",
    totalRow: "Fila de totales",
    bandedRows: "Filas con bandas",
    bandedColumns: "Columnas con bandas",
    firstColumn: "Primera columna",
    lastColumn: "Última columna",
    totals: "Funciones de la fila de totales",
    convertToRange: "Convertir en rango",
    convertConfirm: "¿Desea convertir la tabla en un rango normal?",
    resize: "Cambiar tamaño",
    fnNone: "Ninguno",
    fnSum: "Suma",
    fnAverage: "Promedio",
    fnCount: "Recuento",
    fnCountNums: "Contar números",
    fnMax: "Máx.",
    fnMin: "Mín.",
    fnStdDev: "DesvEst",
    fnVar: "Var",
    errorOverlap: "Una tabla no puede superponerse a otra tabla.",
    errorMerged: "Una tabla no puede contener celdas combinadas.",
    errorInvalidRange: "La referencia no es válida.",
    errorNoRoom: "La fila situada debajo de la tabla debe estar vacía.",
    errorInvalidName: "El nombre de la tabla no es válido.",
    errorDuplicateName: "Ya existe una tabla o un nombre con este nombre.",
    errorNotFound: "La tabla ya no existe.",
    styleBlue: "Azul",
    styleOrange: "Naranja",
    styleGray: "Gris",
    styleGold: "Oro",
    styleLightBlue: "Azul claro",
    styleGreen: "Verde",
    styleBlack: "Negro",
    stylePurple: "Morado",
  },
  ...
  spill: {
    notBlank: "El rango de desbordamiento no está en blanco",
    notBlankDetail:
      "Los resultados de la fórmula no se pueden desbordar porque hay celdas no vacías en el camino.",
    selectObstructing: "Seleccionar celdas obstructoras",
  },
  pasteSpecial: {
    ...
    operation: "Operación",
    all: "Todo",
    allUsingSourceColumnWidths: "Todo usando el ancho de columna de origen",
    formulas: "Fórmulas",
    values: "Valores",
    formats: "Formatos",
    comments: "Comentarios",
    validation: "Validación",
    allExceptBorders: "Todo excepto bordes",
    columnWidths: "Ancho de las columnas",
    formulasAndNumberFormats: "Fórmulas y formatos de números",
    valuesAndNumberFormats: "Valores y formatos de números",
    none: "Ninguna",
    add: "Sumar",
    subtract: "Restar",
    multiply: "Multiplicar",
    divide: "Dividir",
    skipBlanks: "Saltar blancos",
    transpose: "Transponer",
    pasteLink: "Pegar vínculos",
    ok: "Aceptar",
    cancel: "Cancelar",
  },
  drag: {
  ...
  formatCells: {
    ...
    descriptions: {
      ...
      number:
        "Para la presentación de números en general. Para dar formato a valores monetarios, utilice los formatos Moneda y Contabilidad.",
      currency:
        "Los formatos de moneda se utilizan con valores monetarios generales. Use los formatos de contabilidad para alinear las comas decimales en una columna.",
      accounting:
        "Los formatos de contabilidad alinean los símbolos de moneda y las comas decimales en una columna.",
      date: "Los formatos de fecha muestran números de serie de fecha y hora como valores de fecha.",
      time: "Los formatos de hora muestran números de serie de fecha y hora como valores de hora.",
      percentage:
        "Los formatos de porcentaje multiplican el valor de la celda por 100 y muestran el resultado con el símbolo de porcentaje.",
      fraction:
        "Los formatos de fracción muestran los números como fracciones.",
      scientific:
        "Los formatos científicos muestran los números en notación exponencial.",
      text: "Las celdas con formato de texto son tratadas como texto incluso si hay un número en la celda. La celda se presenta exactamente como se introdujo.",
      special:
        "Los formatos especiales son útiles para realizar el seguimiento de valores de listas y bases de datos.",
      custom:
        "Escriba el código de formato de número, usando uno de los códigos existentes como punto de partida.",
    },
    sample: "Muestra",
    decimalPlaces: "Posiciones decimales",
    useThousands: "Usar separador de miles (,)",
    ...
    fractionTypes: [
      "De un dígito (1/4)",
      "De dos dígitos (21/25)",
      "De tres dígitos (312/943)",
      "Como medios (1/2)",
      "Como cuartos (2/4)",
      "Como octavos (4/8)",
    ...
    invalidFormat: "Este formato de número no es válido.",
    textAlignment: "Alineación del texto",
    horizontal: "Horizontal",
    vertical: "Vertical",
    alignGeneral: "General",
    alignLeft: "Izquierda (Sangría)",
    alignCenter: "Centrar",
    alignRight: "Derecha (Sangría)",
    alignTop: "Superior",
    alignMiddle: "Centrar",
    ...
    underline: "Subrayado",
    underlineSingle: "Simple",
    underlineDouble: "Doble",
    color: "Color",
    ...
    border: "Borde",
    borderHint:
      "Elija un estilo de línea y un color y haga clic en un preestablecido, un botón o la vista previa para aplicarlo.",
    borderTop: "Borde superior",
    borderBottom: "Borde inferior",
    borderLeft: "Borde izquierdo",
    borderRight: "Borde derecho",
    borderInsideH: "Borde horizontal interior",
    borderInsideV: "Borde vertical interior",
    ...
    hidden: "Oculta",
    protectionHint:
      "Bloquear celdas u ocultar fórmulas no tiene efecto hasta que protege la hoja.",
  },
  numberFormatMenu: {
    general: "General",
    number: "Número",
    ...
    text: "Texto",
    custom: "Personalizado",
    moreFormats: "Más formatos de número...",
    noSpecificFormat: "Sin formato específico",
  },
  cellStyles: {
    title: "Estilos de celda",
    groups: {
      goodBad: "Bueno, malo y neutral",
      data: "Datos y modelo",
    ...
    names: {
      ...
      neutral: "Neutral",
      calculation: "Cálculo",
      checkCell: "Celda de comprobación",
      explanatory: "Texto explicativo",
      input: "Entrada",
      linkedCell: "Celda vinculada",
      note: "Notas",
      output: "Salida",
  ...
  cellImage: {
    pictureInCell: "Imagen en celda",
    insertTitle: "Insertar imagen en celda",
    placeInCell: "Colocar en celda",
    placeOverCells: "Colocar sobre celdas",
    insertPicture: "Colocar imagen en celda…",
    altText: "Texto alternativo…",
    altTextTitle: "Texto alternativo",
    altTextLabel: "Describa esta imagen para las personas que no puedan verla",
    fromFile: "Este dispositivo…",
    fromUrl: "Desde una dirección web",
    urlLabel: "Dirección de la imagen (https:// o data:image)",
    invalidUrl: "Escriba una dirección https:// de una imagen.",
    readFailed: "No se pudo leer la imagen.",
    picture: "Imagen",
    deletePicture: "Eliminar imagen",
    noPicture: "Elija una imagen o escriba su dirección.",
  },
  edit: {
    typing: "mecanografía",
  },
